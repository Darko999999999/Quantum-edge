...
app = FastAPI(title="Quantum Edge v22")
...
CSS = '''
<style>
*{box-sizing:border-box}body{margin:0;background:#01050b;color:#f3f8ff;font-family:Inter,Arial,Helvetica,sans-serif}.shell{display:grid;grid-template-columns:270px minmax(720px,1fr) 360px;min-height:100vh;background:radial-gradient(circle at top,#071526 0,#02060d 55%,#000 100%)}.side{background:linear-gradient(180deg,#06111f,#02060b);border-right:1px solid #14304d;padding:20px;position:sticky;top:0;height:100vh}.logo{font-size:28px;font-weight:900;line-height:1.05;margin-bottom:24px;color:#fff}.logo span{color:#91ff36;display:block}.nav a{display:flex;align-items:center;gap:10px;color:#dbe9ff;text-decoration:none;padding:14px 12px;border:1px solid #14304d;border-radius:12px;margin-bottom:10px;background:rgba(8,20,36,.55)}.nav a:hover,.nav a:first-child{border-color:#00a6ff;background:rgba(0,136,255,.14)}.api{font-size:13px;color:#9fb0c8;line-height:1.9;margin-top:20px}.dot{display:inline-block;width:10px;height:10px;border-radius:50%;background:#2bdc34;margin-right:8px;box-shadow:0 0 8px #2bdc34}.main{padding:18px;max-width:1120px}.right{padding:18px;border-left:1px solid #14304d;background:rgba(4,11,20,.92)}.top{display:flex;justify-content:space-between;align-items:center;margin-bottom:14px}.title{font-size:32px;font-weight:900}.card,.hero,.v20-hero{background:linear-gradient(180deg,rgba(8,19,35,.96),rgba(3,10,19,.96));border:1px solid #183553;border-radius:14px;padding:16px;margin-bottom:14px;box-shadow:0 14px 38px rgba(0,0,0,.36)}.hero h1{margin:5px 0 6px;font-size:26px}.label{color:#91ff36;font-weight:900;font-size:12px;letter-spacing:.5px}.form-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px}label{display:flex;flex-direction:column;gap:7px;color:#aebcd0;font-size:13px}input,select{width:100%;padding:12px;border-radius:10px;border:1px solid #244260;background:#020812;color:white;font-size:15px}.actions{display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;margin-top:14px}.btn{border:0;border-radius:10px;padding:13px;font-size:15px;font-weight:900;cursor:pointer;text-transform:uppercase}.blue{background:linear-gradient(180deg,#0879ff,#034baf);color:#fff}.green{background:linear-gradient(180deg,#16c958,#068832);color:#fff}.purple{background:linear-gradient(180deg,#7e3be8,#5124a2);color:#fff}.match-card{text-align:center}.match-title{font-size:28px;font-weight:900;display:flex;align-items:center;justify-content:center;gap:18px}.vs{color:#9ab2cd;font-size:18px}.crest{width:58px;height:58px;object-fit:contain;filter:drop-shadow(0 0 10px rgba(0,166,255,.35))}.bigcrest{width:72px;height:72px;object-fit:contain;filter:drop-shadow(0 0 12px rgba(0,166,255,.45))}.crest-fallback{display:inline-flex;align-items:center;justify-content:center;border-radius:50%;background:#0b1b2d;border:1px solid #234866;color:#91ff36;font-weight:900}.v20-kpis{display:grid;grid-template-columns:repeat(5,1fr);gap:10px;margin-top:13px}.v20-kpis div,.stat div{background:#030b15;border:1px solid #16324e;border-radius:10px;padding:11px;text-align:center}.v20-kpis small,.stat span{display:block;color:#8fa3bb;margin-bottom:6px}.v20-kpis strong{color:#91ff36;font-size:20px}.flow-cards{display:grid;grid-template-columns:repeat(5,1fr);gap:10px}.flow-tile{border:1px solid #234866;border-radius:10px;padding:12px;text-align:center;background:#03101d}.flow-tile b{font-size:30px;display:block;margin:5px 0}.flow-tile.green b{color:#52ff47}.flow-tile.red b{color:#ff4f6d}.flow-tile.purple b{color:#b566ff}.flow-tile.orange b{color:#ffc13b}.flow-tile.blue b{color:#49a7ff}.flow-tile small{font-size:11px;color:#cbd8e9}.bar-row{margin:11px 0}.bar-label{display:flex;justify-content:space-between;color:#dbe9fa;font-size:13px;margin-bottom:5px}.bar-bg{height:10px;border-radius:999px;background:#07101d;border:1px solid #203d5c;overflow:hidden}.bar-fill{height:100%;background:#91ff36}.bar-fill.red{background:#ff4f6d}.bar-fill.orange{background:#ffb347}.bar-fill.blue{background:#49a7ff}.bar-fill.purple{background:#b566ff}.score-grid{display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px}.score{background:#030b15;border:1px solid #16324e;border-radius:12px;padding:18px;text-align:center}.score small{color:#92a4bc}.score b{display:block;font-size:42px;color:#91ff36;margin-top:8px}.score.value b{color:#ffc13b}.score.chaos b{color:#ff4f6d}.market-grid{display:grid;grid-template-columns:repeat(5,1fr);gap:8px}.market-grid div{background:#030b15;border:1px solid #16324e;border-radius:10px;padding:10px;text-align:center}.market-grid small{color:#8fa3bb}.market-grid b{display:block;color:#91ff36;margin-top:6px}.stat{display:grid;grid-template-columns:1fr 1fr;gap:10px}.mini{background:#030b15;border:1px solid #16324e;border-radius:12px;padding:12px;margin-bottom:10px;color:#d8e6f7}.mini b{color:#91ff36}.hist-row{display:grid;grid-template-columns:1fr 2fr 1fr 1fr 1fr;gap:8px;background:#030b15;padding:10px;border-radius:12px;margin-bottom:8px}.muted{color:#adbbcf;line-height:1.5}.teamline{display:grid;grid-template-columns:70px 1fr;gap:12px;align-items:center;margin-bottom:12px}.teamline h3{margin:0;color:#49a7ff}.teamline p{margin:4px 0 0;color:#b8c7da}@media(max-width:1050px){.shell{display:block}.side,.right{position:relative;height:auto;border:0}.main{padding:12px}.form-grid,.actions,.v20-kpis,.flow-cards,.score-grid,.stat,.hist-row,.market-grid{grid-template-columns:1fr}.title{font-size:24px}.match-title{font-size:24px}.bigcrest{width:54px;height:54px}}
</style>
'''
...
def dashboard(v, result=None, hist=False):
    ...
    return f'<!doctype html><html lang="pl"><head><meta charset="utf-8"><title>Quantum Edge v22</title><meta name="viewport" content="width=device-width,initial-scale=1">{CSS}</head><body><div class="shell"><aside class="side"><div class="logo">⚡ QUANTUM <span>EDGE</span></div><div class="nav"><a href="/">🏠 Dashboard</a><a href="/">🔴 Live</a><a href="/history">↺ History</a><a href="/">🔎 Value Finder</a><a href="/">⚙ Settings</a></div><div class="api"><div><span class="dot"></span>Odds API</div><div><span class="dot"></span>Understat</div><div><span class="dot"></span>Football-Data</div><div><span class="dot"></span>TheSportsDB badges</div><div>Model: v22</div></div></aside>{main_html}{right_html}</div></body></html>'
